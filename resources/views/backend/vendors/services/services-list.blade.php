                                ...
                                <div id="basic-6_wrapper" class="dataTables_wrapper">
                                    <table class="display dataTable" id="basic-6" role="grid" aria-describedby="basic-6_info" style="width: 1552px;">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 106px;">Services Price</th>
                                            <th class="sorting" tabindex="0" aria-controls="basic-6" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 106px;">Services Location</th>
