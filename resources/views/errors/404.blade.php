...
<html lang="en">
    <head>
        ...
        <title>{{ $title ?? '404 | Roadside Rescue' }}</title>
        <!-- Google font-->
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-100" src="../assets/images/other-images/sad3.gif" alt="">
          ...
          <div><a class="btn btn-danger-gradien btn-lg" href="{{ route('admindashboard') }}">BACK TO HOME PAGE</a></div>
        </div>
      </div>
      <!-- error-404 end      -->
    </div>
